        ...
        <div>
            ...
            <div className='container mx-auto py-5'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="bg-green-400 rounded-md text-white p-2">Sign In</button>
                </form>
                <hr className='my-3'></hr>
                <p>Do not have an account? go to <Link href="/register" className="text-blue-500 hover:underline"> Register </Link> Page</p>
